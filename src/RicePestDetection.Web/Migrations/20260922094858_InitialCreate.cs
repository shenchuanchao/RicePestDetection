        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HarmDescription = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    PreventionMethod = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    PestId = table.Column<int>(type: "INTEGER", nullable: true),
                    ImagePath = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ResultName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Confidence = table.Column<float>(type: "REAL", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetectionRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetectionRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetectionRecords_Pests_PestId",
                        column: x => x.PestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetectionRecords_PestId",
                table: "DetectionRecords",
                column: "PestId");

            migrationBuilder.CreateIndex(
                name: "IX_DetectionRecords_UserId",
                table: "DetectionRecords",
                column: "UserId");
